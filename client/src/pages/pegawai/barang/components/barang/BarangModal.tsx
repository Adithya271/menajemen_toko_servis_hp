...
export default function BarangModal({
  ...
  return (
    <>
      ...
      <div className="fixed z-50 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[550px] max-h-[90vh] bg-white rounded-lg shadow-xl flex flex-col">
        ...
        <div className="flex flex-col flex-1 min-h-0">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <p className="text-xs text-blue-600">
                  Masukkan harga jual dan harga modal sesuai kebutuhan.
                  Persentase margin akan dihitung otomatis.
                </p>
              </div>
          ...
          <div className="flex justify-end gap-3 px-6 py-4 border-t bg-gray-50 rounded-b-lg flex-shrink-0">
            <button
              type="button"
